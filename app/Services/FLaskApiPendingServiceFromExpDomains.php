...
class FLaskApiPendingServiceFromExpDomains
{
    ...
    {
        $response = Http::sink(storage_path('app/pending_domains_from_expired_domains.json'))
            ->get("{$this->apiBaseUrl}/get_pending_domains_from_expired_domains");

        if ($response->successful()) {
            $filePath = storage_path('app/pending_domains_from_expired_domains.json');
