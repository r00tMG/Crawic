            ...
            <div class="table-responsive-lg table-responsive-sm table-responsive-md">
                ...
                <table class="table table-bordered width100" id="table">
                    ...
                    <tbody>
                        ...
                        @foreach($pending_domains as $pending_domain)
                        <tr>
                            <td>{{ $pending_domain->id }}</td>
                            <td>{{ $pending_domain->domain_name }}</td>
                            <td>{{ $pending_domain->age }}</td>
                            <td>{{ $pending_domain->DA }}</td>
                            <td>{{ $pending_domain->PA }}</td>
                            <td>{{ $pending_domain->DR }}</td>
                            <td>{{ $pending_domain->CF }}</td>
                            <td>{{ $pending_domain->TF }}</td>
                            <td>{{ $pending_domain->backlinks }}</td>
...
<script>
    ...
    /* $(function() {
        var table = $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{!! URL::to('user/domain_available') !!}',
            columns: [
