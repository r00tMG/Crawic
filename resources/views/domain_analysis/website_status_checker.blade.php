...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Website Status Checker</li>
    </ol>
</section>
                ...
                <form  method="get" enctype="multipart/form-data" @cannot('researchTools', ['App\Models\User']) class=" left-5 right-5 opacity-20" @endcannot>
                    ...
                    <div class="row mx-n2">
                        ...
                        <div class="col-auto px-2">
                            <a href="{{ URL::to('user/website-status-checker') }}" class="btn btn-outline-secondary ml-auto">{{ __('Reset') }}</a>
                        </div>
                    </div>
                </form>
                            ...
                            <div class="list-group list-group-flush my-n3">
                                ...
                                <div class="list-group-item px-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 col-lg-8 text-truncate d-flex align-items-center">{{ ($result ? $result->getStatusCode() : '404') }}</div>
                                    </div>
                                </div>
