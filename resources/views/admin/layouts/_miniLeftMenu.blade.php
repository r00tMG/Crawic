<ul class=" navigation">
    <li {!! (Request::is('admin') ? 'class="active"' : '' ) !!}>
        <a href="{{ route('admin.dashboard') }}">
            ...
            <span class="mm-text">SEO Dashobard</span>
        </a>
    </li>
    <li {!! (Request::is('admin') ? 'class="active"' : '' ) !!}>
        <a href="{{ URL::to('admin/index1') }}">
            ...
            <span class="mm-text">Domain Overview</span>
        </a>
    </li>
    <li {!! (Request::is('admin/log_viewers') || Request::is('admin/log_viewers/logs') ? 'class="active" ' : '' ) !!}>
        ...
        <a href="{{  URL::to('admin/log_viewers') }}">
            ...
            <span class="mm-text">Traffic Analysis</span>
        </a>
    </li>
    ...
    <li {!! ( Request::is('admin/laravel_charts') || Request::is('admin/database_charts') ? 'class="active menu-dropdown"' : 'class="menu-dropdown"' ) !!}>
        <a href="#">
            ...
            <span class="title mm-text">SEO</span>
