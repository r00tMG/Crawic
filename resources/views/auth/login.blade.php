                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('login') }}" autocomplete="on" method="post" role="form"
                                ...
                                <h3 class="black_bg">
                                    <img src="{{ asset('images/dologo.png') }}" alt="Crawic ">
                                    <br>Log In</h3>
                                <!-- CSRF Token -->
                        ...
                        <div id="register" class="animate form">
                            <form action="{{ route('admin.signup') }}" autocomplete="on" method="post" role="form"
                                id="register_here">
                                <h4 class="black_bg my-3 text-center">
                                    <img src="{{ asset('images/dologo.png') }}" alt="Crawic ">
                                    <br>
                                    <br>
                                    
                                    website under construction. Sign Up will be enabled soon</h4>
                        ...
                        <!-- <div id="register" class="animate form">
                            <form action="{{ route('admin.signup') }}" autocomplete="on" method="post" role="form"
                                ...
                                <h3 class="black_bg my-3">
                                    <img src="{{ asset('images/dologo.png') }}" alt="Dofynd">
                                    <br>Sign Up</h3>
                        ...
                        <!-- <div id="forgot" class="animate form">
                            <form action="{{ url('admin/forgot-password') }}" autocomplete="on" method="post"
                                ...
                                <h3 class="black_bg my-3">
                                    <img src="{{ asset('images/dologo.png') }}" alt="Dofynd"><br>Forgot Password</h3>
